...
public class AntibanTask extends Node {
    ...
    public void execute() {
        ...
        case 0:
            ...
            randStatPoint.x += Random.nextInt(-10, 10); //Don't have the mouse go to the EXACT same spot every time! <img src='http://powerbot-gold4rs.netdna-ssl.com/community//public/style_emoticons/<#EMO_DIR#>/happy.png' class='bbc_emoticon' alt=':)' />
